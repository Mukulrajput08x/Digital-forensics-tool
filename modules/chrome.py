...
def get_chrome_history():
    ...
    if not safe_copy_db(history_path, temp_path):
        return [{"error": "Chrome History file not found or browser may be open"}]
...
def get_chrome_downloads():
    ...
    temp_path = "chrome_downloads_temp.db"
...
def get_chrome_bookmarks():
    ...
    if not os.path.exists(bookmark_path):
        return [{"error": "Chrome Bookmarks file not found"}]
...
def get_chrome_cookies():
    ...
    temp_path = "chrome_cookies_temp.db"

    if not safe_copy_db(cookie_path, temp_path):
        return [{"error": "Chrome Cookies file not found or browser may be open"}]
