...
def get_edge_history():
    ...
    temp_path = "edge_history_temp.db"

    if not safe_copy_db(history_path, temp_path):
        return [{"error": "Edge History file not found or browser may be open"}]
...
def get_edge_downloads():
    ...
    temp_path = "edge_downloads_temp.db"
...
def get_edge_bookmarks():
    ...
    if not os.path.exists(bookmark_path):
        return [{"error": "Edge Bookmarks file not found"}]
...
def get_edge_cookies():
    ...
    temp_path = "edge_cookies_temp.db"

    if not safe_copy_db(cookie_path, temp_path):
        return [{"error": "Edge Cookies file not found or browser may be open"}]
